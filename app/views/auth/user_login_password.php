...
<div style="width:100%;max-width:420px">
  ...
  <div style="background:#fff;border-radius:16px;box-shadow:0 4px 24px rgba(0,0,0,.08);padding:32px">
    <h2 style="font-size:20px;font-weight:700;margin-bottom:6px;color:#1A1A1A">Enter your password</h2>
    <p style="font-size:13px;color:#9A9890;margin-bottom:24px"><?= htmlspecialchars($email) ?></p>
    ...
    <div style="text-align:center;margin-top:20px;font-size:12px;color:#9A9890">
      <a href="<?= ASSET_URL ?>/login/back" style="color:#9A9890;font-weight:600">← Not you? Use a different email</a>
    </div>
  </div>
